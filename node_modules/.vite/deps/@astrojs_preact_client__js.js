...
var client_default = (element) => async (Component, props, { default: children, ...slotted }, { client }) => {
  ...
  if (signalsRaw) {
    const { signal } = await import("./signals.module-XRB3ESOH.js");
